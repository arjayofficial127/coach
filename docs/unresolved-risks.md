# Phase 2 unresolved risks

Phase 2 is a strong personal prototype, not a production general-purpose browser. The original
...
| Priority | Risk | Current Phase 2 position | Exit criterion |
| --- | --- | --- | --- |
...
Phase 3 must preserve the trusted-shell/remote-site separation and treat each relaxation of a
