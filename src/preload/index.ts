...
const api: LatticeApi = {
  ...
  localWorkspace: {
    ...
    listFileRevisions: (input) => ipcRenderer.invoke(IPC.workspaceListFileRevisions, input),
    readFileRevision: (input) => ipcRenderer.invoke(IPC.workspaceReadFileRevision, input),
